...
[data.AliasStatus, data.vm, data.MinVel_Correction] = dealias_spectra_vm_column_qualitiy_check( data.vm, 10.*log10(data.Ze), data.range, data.AliasStatus, data.Aliasmask, abs(data.velocity(:,1)), data.MinVel_Correction, data.range_offsets );
